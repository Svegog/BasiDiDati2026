...
Lo schema scheletro individua le entit\`{a} principali e le associazioni fondamentali,
senza ancora specificare gli attributi n\'e le cardinalit\`{a} precise.

\begin{figure}[H]
  \centering
  % -- Inserire qui l'immagine dello schema scheletro ------
  % \includegraphics[width=0.9\textwidth]{immagini/schema_scheletro.png}
  \fbox{\parbox{0.9\textwidth}{\centering\vspace{3cm}
    \textit{[Inserire immagine: schema\_scheletro.png]}\\
    Esportare il diagramma E/R come PNG e salvarlo in \texttt{immagini/}
  \vspace{3cm}}}
  \caption{Schema scheletro --- entit\`{a} e associazioni principali}
  \label{fig:schema-scheletro}
\end{figure}

Le entit\`{a} individuate sono: \entita{Proprietario}, \entita{Cliente},
\entita{Ombrellone}, \entita{Dipendente}, \entita{Prodotto},
\entita{Fornitore}, \entita{Ordine}.

Le associazioni principali sono: \relazione{Effettua} (Proprietario--Ordine),
\relazione{Prenota} (Cliente--Ombrellone), \relazione{LavoraIn} (Dipendente--Turno),
\relazione{Rifornisce} (Fornitore--Ordine), \relazione{Contiene} (Ordine--Prodotto).
