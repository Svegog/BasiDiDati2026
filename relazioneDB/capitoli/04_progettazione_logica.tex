...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{L{4cm} R{1.6cm} L{8cm}}
    ...
    \entita{Noleggio\_lettino} & 7500      & $\sim$ 15 al giorno \\
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{L{3cm} C{2.5cm} R{1.6cm} L{6cm}}
    ...
    \midrule
    Emissione             & 1:N     & 1000    & =\entita{Ordine} \\
    Inserimento           & 1:N     & 1000    & =\entita{Ordine} \\
    Dettaglio\_Ordine     & N:M     & 10000   & $\sim$ 10 prodotti per \entita{Ordine} \\
    Offerta               & 1:N     & 300     & =\entita{Catalogo} \\
    Relativa              & 1:N     & 300     & =\entita{Catalogo} \\
    Appartenenza          & 1:N     & 150     & =\entita{Prodotto} \\
    Acquisto              & 1:N     & 7500    & =\entita{Noleggio\_lettino} \\
    Tipologia             & 1:N     & 7500    & =\entita{Noleggio\_lettino} \\
    \bottomrule
  \end{tabularx}
\end{table}
