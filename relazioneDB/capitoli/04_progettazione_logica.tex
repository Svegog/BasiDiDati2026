...
Dato che è tenuto in memoria lo storico delle prenotazioni assumiamo i volumi
per i dati degli ultimi 5 anni. Dati più vecchi verranno eliminati dal sistema.
I turni sono mantenuti nel sistema solo per una stagione.
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{L{4cm} R{1.6cm} L{8cm}}
    \toprule
    \rowcolor{primary!15}
    \textbf{Entità} & \textbf{Volume} & \textbf{Note} \\
    \midrule
    \entita{Proprietario}      & 2--5      & Soci dello stabilimento \\
    \entita{Cliente}           & 2.000     & Clienti registrati \\
    \entita{Ombrellone}        & 200       & Postazioni totali \\
    \entita{Fila}              & 10        & File totali \\
    \entita{Prenotazione}      & 7.500     & $\sim$ 10 prenotazioni/ombrellone a stagione \\
    ...
    \entita{Dipendente}        & 20        & Personale stagionale \\
    \entita{Turno}             & 1.800     & ~90 turni/dipendente/stagione \\
    \entita{Mansione}          & 10        & Ruoli necessari \\
    \entita{Prodotto}          & 150       & Articoli abitualmente comprati \\
    \entita{Categoria}         & 20        & Categorie dei prodotti \\
    \entita{Fornitore}         & 20        & Fornitori abituali \\
    \entita{Catalogo}          & 300       & Coppie fornitore-prodotto fornito \\
...
\begin{table}[htbp]
  ...
  \rowcolors{2}{rowalt}{white}
  \begin{tabularx}{\textwidth}{L{3cm} C{2.5cm} R{1.6cm} L{6cm}}
    \toprule
    \rowcolor{primary!15}
    ...
    Offerta               & 1:N     & 300     & =\entita{Catalogo} \\
    Relativa              & 1:N     & 300     & =\entita{Catalogo} \\
    Appartenenza          & 1:N     & 150     & =\entita{Prodotto} \\
    ...
    Assegnazione          & 1:N     & 1.800   & =\entita{Turno} \\
    Svolgimento           & 1:N     & 1.800   & =\entita{Turno} \\
    \bottomrule
  \end{tabularx}
\end{table}
