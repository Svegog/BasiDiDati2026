...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{C{1cm} L{4cm} L{4cm} L{6cm}}
    ...
    da essere una entità assestante, viene sostituito da l'entità \textit{Prenotazione_Lettino} 
    associata. \\[4pt]
...
\begin{table}[H]
  ...
  \label{tab:concetti}
  \rowcolors{2}{rowalt}{white}
  \begin{tabularx}{\textwidth}{L{3cm} C{3cm} L{8.5cm}}
    \toprule
    \rowcolor{primary!15}
    ...
    \entita{Prenotazione}    & Entità      & Lega un cliente a un ombrellone o lettino per una durata concordata \\
    ...
    \entita{Mansione}        & Entità      & Compito che un dipendente svolgerà durante il turno in questione \\
    ...
    \entita{Contiene}     & Associazione & Lega un ordine ai prodotti ordinati (con quantità) \\
    \bottomrule
  \end{tabularx}
\end{table}
