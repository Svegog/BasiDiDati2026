...
\begin{notabox}[Vincolo implicito]
Un ombrellone non può essere prenotato due volte per lo stesso periodo. Questo
vincolo non è esprimibile nello schema E/R ma verrà implementato nell'applicativo.
\end{notabox}
...
\begin{figure}[H]
  \centering
  \includegraphics[angle=90, width=0.88\textwidth]{immagini/03/CompletoER.png}
